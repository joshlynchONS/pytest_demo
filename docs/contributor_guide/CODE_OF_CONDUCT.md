# Code of conduct for `pytest_demo`

Contributors to this repository hosted by `Analysis Function` are expected to follow the
...
- "Project", we mean this `pytest_demo` GitHub repository;
- "Maintainer", we mean the `Analysis Function` organisation owners; and
- "Leadership", we mean both `Analysis Function` organisation owners, line managers, and other
  leadership within the Methodology and Quality.
